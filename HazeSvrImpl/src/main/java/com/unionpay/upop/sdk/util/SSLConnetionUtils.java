...
public class SSLConnetionUtils {
	...
	A:
	https://unionpaysecure.com/api/BSPay.action（后台交易）
	https://unionpaysecure.com/api/Query.action（查询）
	
	private static final String upopHost = "unionpaysecure.com";
	
	B：
	https://besvr.unionpaysecure.com/api/BSPay.action（后台交易）
	https://query.unionpaysecure.com/api/Query.action（查询）
	private static final String upopHost = "query.unionpaysecure.com";
	*/

	private static final String upopHost = "query.unionpaysecure.com";//商户根据实际情况修改，参考上面注释说明
	private static final int HTTPS_PORT = 443;

	// 要导入的证书的别名
	private static final String certFileAlias = "unionpaysecure";//商户根据实际情况修改，别名，可以不修改

	// Java Trust Store密码，初始密码为changeit
	private static final String trustStorePassword = "changeit";//商户根据实际情况修改，默认是changeit

	// Java Trust Store的路径
	private static final String JAVA_HOME = "C:\\Program Files\\Java\\jre6";//商户根据实际情况修改
